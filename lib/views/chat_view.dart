            ...
            children: [
              Expanded(
                child: ListView.builder(
                  controller:
                      scrollController, // بنربط ال ListView بال ScrollController اللي عملناه عشان نقدر نتحكم في سلوك السكرول بتاعها
                  reverse:
                      true, // بنخليها تبدأ من تحت لفوق عشان الرسائل الجديدة تظهر تحت
                  itemCount: messagesList.length,
                  itemBuilder: (context, index) {
                    return messagesList[index].senderEmail == userEmail
                        ? ChatBubble(message: messagesList[index])
                        : ChatBubbleForMyFriend(message: messagesList[index]);
                  },
                ),
              ),
              ...
              TextField(
                ...
                onSubmitted: (enteredMessage) {
                  BlocProvider.of<ChatCubit>(
                    context,
                  ).sendMessage(message: enteredMessage, email: userEmail!);
